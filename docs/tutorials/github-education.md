...
description: Apply for GitHub Education benefits and activate Copilot Pro with Claude.
---
...
2. Look for the green **Coupon applied** bar — this confirms your application was approved
   ...
   ![GitHub Education Benefits page showing approved coupon](../assets/images/github-education-benefits.png)
...
2. Under **Repository access**, choose which repositories the coding agent can act on (you can set this to **All repositories**)
   ...
   ![Copilot coding agent settings showing repository access and partner agents](../assets/images/github-copilot-coding-agent.png)
...
3. Optionally toggle **Allow Codex coding agent** to On as well
   ...
   ![Partner agents section with Claude coding agent enabled](../assets/images/github-copilot-partner-agents.png)
